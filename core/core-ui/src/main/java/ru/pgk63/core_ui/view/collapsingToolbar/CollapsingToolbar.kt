package ru.pgk63.core_ui.view.collapsingToolbar
...
data class CollapsingTitle(
    ...
    companion object {
        @Composable
        fun large(titleText: String) = CollapsingTitle(titleText, PgkTheme.typography.heading)

        @Composable
        fun medium(titleText: String) = CollapsingTitle(titleText, PgkTheme.typography.body)
    }
